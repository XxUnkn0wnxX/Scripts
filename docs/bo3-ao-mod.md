...
- Script: [`BO3 AO-Mod (Version 2.4c) [ZEN].gpc`](../Zen%20Scripts/BO3%20AO-Mod%20%28Version%202.4c%29%20%5BZEN%5D.gpc)
...
- **D-PAD DOWN double-tap: GobbleGum one-shot**
  ...
  - Uses the script's default PS4 defines: Square + R1, then Triangle taps.
  > ZMode TRUE only.
