...
- Jitter: runs while SHOOT is held (normal only; pump is disabled). Works for most guns, including shotguns. Requires a lethal grenade equipped (for example, Semtex) in the grenade slot.
