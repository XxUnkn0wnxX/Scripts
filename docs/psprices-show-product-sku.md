...
[`userscripts/PSPrices-Show-Product-SKU.user.js`](../userscripts/PSPrices-Show-Product-SKU.user.js) is a Tampermonkey userscript that displays the public PlayStation product SKU on PSPrices product pages.
