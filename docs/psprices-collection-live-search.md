...
While candidate hydration is still running, the UI labels already verified matches as confirmed results. Remaining undisplayed items are reported through the `Show more` button.
