...
[`userscripts/StackExchange-Reveal-Spoilers.user.js`](../userscripts/StackExchange-Reveal-Spoilers.user.js) is a Tampermonkey userscript that makes spoiler blocks visible across Stack Exchange sites.
