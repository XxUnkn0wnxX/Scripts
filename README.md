...
| Item | Description | Docs |
| --- | --- | --- |
| [`PSPrices-PlayStation-Checkout-Link.user.js`](https://raw.githubusercontent.com/XxUnkn0wnxX/Scripts/master/userscripts/PSPrices-PlayStation-Checkout-Link.user.js) | Adds regional PS Store checkout-link panels and an unlocked badge, hides unlock prompts and site-wide promos, and provides saved advanced timing and fallback settings. | [Docs](docs/psprices-playstation-checkout-link.md) |
| [`PSPrices-Collection-Live-Search.user.js`](https://raw.githubusercontent.com/XxUnkn0wnxX/Scripts/master/userscripts/PSPrices-Collection-Live-Search.user.js) | Adds cached live substring search to PSPrices avatar and theme collections, with background indexing, platform/free filters, progressive detail hydration, and saved advanced settings. | [Docs](docs/psprices-collection-live-search.md) |
| [`PSPrices-Show-Product-SKU.user.js`](https://raw.githubusercontent.com/XxUnkn0wnxX/Scripts/master/userscripts/PSPrices-Show-Product-SKU.user.js) | Displays and copies the public PlayStation product SKU on PSPrices product pages, with Avatar SKU, Theme SKU, or generic SKU labels and matching helper text in a native-style panel below buy, checkout, or unavailable-store sections. | [Docs](docs/psprices-show-product-sku.md) |
...
| [`Youtube-shorts-switcher.user.js`](https://raw.githubusercontent.com/XxUnkn0wnxX/Scripts/master/userscripts/Youtube-shorts-switcher.user.js) | Opens YouTube Shorts in the normal watch player through an action button or a recorded, saved keyboard shortcut. | [Docs](docs/youtube-shorts-switcher.md) |
